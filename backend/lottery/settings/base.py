...
# CompressedStaticFilesStorage: no manifest, so no "Missing manifest entry" errors when
# collectstatic runs in a different path (e.g. Render Docker context). Still compresses.
